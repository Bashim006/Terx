...
var obstacle, obstacleGroup, obstacle1Image, obstacle1Image, obstacle2Image, obstacle3Image, obstacle4Image, obstacle5Image, obstacle6Image;
...
function spwanobstacle(){
  var radm=Math.round(random(1,6))
  switch(radm){
